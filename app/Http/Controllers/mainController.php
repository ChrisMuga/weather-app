...
class mainController extends BaseController
{
    ...
    public function fetch()
    {
        ...
        $json       =   file_get_contents('http://api.openweathermap.org/data/2.5/group?id=184745,186301,191245,184622,187896&units=metric&APPID=bec78ab9a765701d40fc9d0b9bc1aace');
